...
#Decisão do MC
    ...
    #O MC tenta sair da bibliteca mas na porta há um tipo de tranca com segredo. Ele tem de decifrar o segredo.
        ...
        #"Opção 1"O MC sai da biblioteca e vai para casa e o jogo acaba
        ...
        #"Opção 2"O MC sai da biblioteca e vai para casa se encontrar com seus amigos e progredir a história
        print("Depois de resolver o segredo, você sai da biblioteca...")
        input("...")
        print("Pensativo...")
        input("...")
        print("Você se decide, em encontrar seus amigos!")
        input("Ligar?")
        print("Você liga para seus amigos!")
        input("...")
        input("...")
        input("...")
        print("Eles não atendem!")
        input("Ir para casa.")
        print("Você vai para casa!")
        #Chegando em casa, o MC liga novamente!
